...
const Menu = () => {
    ...
    return (
        <div>
            <Helmet>
                <title>Bistro Boss Menu | Home</title>
            </Helmet>
            <Cover img={img} bannerTitle="Our Menu" bannerDetails="Would you like to try a dish?"></Cover>
            <SectionTitle subHeading="Don't Miss" heading="Today's  Offer"></SectionTitle>
            <MenuCategory items={offered} buttonText="Explore all foods" category="salad"></MenuCategory>
            <MenuCategory items={desserts}  buttonText="Order your favorite foods" category="desserts" title="Desserts" img={chef} details="Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, libero accusamus laborum deserunt ratione dolor officiis praesentium! Deserunt magni aperiam dolor eius dolore at, nihil iusto ducimus incidunt quibusdam nemo."></MenuCategory>
            <MenuCategory items={pizza} buttonText="Order your favorite foods" title="Pizza" category="pizza" img={chef} details="Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, libero accusamus laborum deserunt ratione dolor officiis praesentium! Deserunt magni aperiam dolor eius dolore at, nihil iusto ducimus incidunt quibusdam nemo."></MenuCategory>
            <MenuCategory items={salads}  buttonText="Order your favorite foods" category="salad" title="Salads" img={chef} details="Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, libero accusamus laborum deserunt ratione dolor officiis praesentium! Deserunt magni aperiam dolor eius dolore at, nihil iusto ducimus incidunt quibusdam nemo."></MenuCategory>
            <MenuCategory items={soups}  buttonText="Order your favorite foods" title="Soups" category="soup" img={chef} details="Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, libero accusamus laborum deserunt ratione dolor officiis praesentium! Deserunt magni aperiam dolor eius dolore at, nihil iusto ducimus incidunt quibusdam nemo."></MenuCategory>
