...
const Testimonials = () => {
    ...
    useEffect(() => {
        fetch("https://food-finder-chi-puce.vercel.app/reviews")
            .then(res => res.json())
            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                {
                    reviews.map(review => <SwiperSlide key={review._id}>
                        <div className="my-12 mx-24 flex flex-col justify-center items-center gap-4">
                            ...
                            <p className="tex-center">{review.details}</p>
